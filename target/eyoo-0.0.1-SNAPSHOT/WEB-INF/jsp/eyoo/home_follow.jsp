		...
		<div style="width: 70%; float: left;">
				...
				<div id="eyooItem">
					...
					<div class="container"
						...
						<div
							...
							<a style="color: #333; font-size: 20px" href="javascrip:;">${eyoo.user.nickname }</a><br>
					...
					<div class="container"
						...
						<div class="btn-group" style="width: 100%">
							...
							<button onclick="javascript:loadComment(${eyoo.eyooId});"
								...
								id="bt${status.index }"><span style="color: #fff;" id="likespan${eyoo.eyooId }"
										class="glyphicon glyphicon-comment" aria-hidden="true"></span>
									<span style="color: #fff;" id="likeCount${eyoo.eyooId}">${eyoo.commentCount}</span></button>
							<!---------------------------------------------------- 点赞 --------------------------------------------------------->
			...
			<div class="container" style="width: auto; background-color: #fff;">
				...
				<ul class="pagination pagination-lg">
					<!-- 上一页 -->
					<li><a href="queryAlleyooFollow.action?pageNo=${page.pageNo-1 }">&laquo;</a></li>
					<c:choose>
					...
					<c:forEach begin="${begin}" end="${end}" var="i">
						...
						<c:if test="${i!=page.pageNo }">
							<li><a href="queryAlleyooFollow.action?pageNo=${i }">${i}</a></li>
						</c:if>
					</c:forEach>
					<!-- 下一页 -->
					<li><a href="queryAlleyooFollow.action?pageNo=${page.pageNo+1 }">&raquo;</a></li>
				</ul>
			</div>
